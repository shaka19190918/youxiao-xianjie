...
const CACHE = 'child-learning-v37';
const PINYIN_KEYS = 'a1 a2 a3 a4 ai1 ai2 ai3 ai4 an1 an2 an3 an4 ang1 ang2 ang3 ang4 ao1 ao2 ao3 ao4 b ba1 ba2 ba3 ba4 bo1 c ch chi chi1 chi2 chi3 chi4 ci ci1 ci2 ci3 ci4 d de1 de2 e1 e2 e3 e4 ei1 ei2 ei3 ei4 en1 en2 en3 en4 eng1 eng2 eng3 eng4 er1 er2 f fo1 fo2 g ge1 h he1 i1 i2 i3 i4 ie1 in1 in2 in3 in4 ing1 ing2 ing3 ing4 iu1 j ji1 k ke1 l le1 le4 m mi1 mi2 mi3 mi4 mo1 n ne1 ne4 o1 o2 o3 o4 ong1 ong2 ong3 ong4 ou1 ou2 ou3 ou4 p po1 po2 po3 po4 q qi1 r ri ri2 ri3 ri4 s sh shi shi1 shi2 shi3 shi4 si si1 si2 si3 si4 t te1 te4 u1 u2 u3 u4 ue1 ui1 un1 un2 un3 un4 v1 v2 v3 v4 vn1 vn2 vn3 vn4 w wei1 wen1 weng1 wu wu1 wu2 wu3 wu4 x xi1 y ye ye1 ye2 ye3 ye4 yi yi1 yi2 yi3 yi4 yin yin1 yin2 yin3 yin4 ying ying1 ying2 ying3 ying4 you1 yu yu1 yu2 yu3 yu4 yuan yuan1 yuan2 yuan3 yuan4 yue yue1 yue2 yue3 yue4 yun yun1 yun2 yun3 yun4 z zh zhi zhi1 zhi2 zhi3 zhi4 zi zi1 zi2 zi3 zi4 zw_chang2 zw_di2 zw_di4 zw_jiao4 zw_jue2 zw_le4 zw_shao3 zw_shao4 zw_yue4 zw_zhang3 zw_zhi1 zw_zhi3';
const PINYIN = PINYIN_KEYS.split(' ').map(x=>`./assets/pinyin/${x}.mp3`);
...
const POEM_KEYS = ['poem_yong_e','poem_hua','poem_min_nong','poem_jing_ye_si','poem_chun_xiao','poem_deng_guan_que_lou','poem_jiang_xue'];
...
const PRECACHE = [
  ...
  './assets/pets/labrador-cartoon.webp'
];
...
self.addEventListener('message', event => {
  ...
  const learningAudio = [...PINYIN, './assets/pinyin/a2.wav','./assets/pinyin/a3.wav','./assets/pinyin/a4.wav','./assets/pinyin/e3.wav','./assets/pinyin/o2.wav','./assets/pinyin/o3.wav','./assets/pinyin/o4.wav', ...MATH, ...VOICE.map(x=>`./assets/voice/${x}.mp3`), './assets/voice/poem_yong_e_l1.wav', ...ENGLISH.flatMap(x => [
