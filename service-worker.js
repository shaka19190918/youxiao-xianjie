...
const CACHE = 'child-learning-v29';
...
const VOICE = ['correct','greeting_afternoon','greeting_evening','greeting_late_morning','greeting_morning','greeting_night','greeting_noon','pet_bath','pet_hello','pet_hungry','pet_play','poem_chun_xiao','poem_deng_guan_que_lou','poem_hua','poem_jiang_xue','poem_jing_ye_si','poem_min_nong','poem_yong_e_v3','retry','trace_pass','trace_retry','trace_start'];
const PRECACHE = [
