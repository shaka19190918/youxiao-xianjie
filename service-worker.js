...
const CACHE = 'child-learning-v43';
const PINYIN_KEYS = '';
const PINYIN = [];
...
self.addEventListener('message', event => {
  ...
  const learningAudio = [...MATH, ...TEXTBOOK, ...VOICE.slice(0, 36).map(x=>`./assets/voice/${x}.mp3`), './assets/voice/poem_yong_e_l1.wav', ...ENGLISH.flatMap(x => [
